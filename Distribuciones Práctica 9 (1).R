...
#La probabilidad de tener 4 o menos respuestas si un estudiante 
#intenta 

#Solución para que saque 4 respuestas correctas: 

#Dado que sólo una de cada 5 respuestas posibles es correcta, la 
#probabilidad de responder correctamente una pregunta al azar es 
# de 1/5= 0.2. Podemos encontrar la probabiliad de tener exactamente 
# 4 respuestas correctas por intentos aletorios de la siguiente manera: 

# 1. Probabilidad de escoger una respuesta de 5 osibles 
p<-1/5

# 2.- Espacio muestral (12 preguntas en total) 
n<-12

#3.- Probabilidad de tener 4 respuestas correctas aelegidas 
#aleatoriamente
k<-4
...
# Ejercicio de cómo realizar nuestro gráfico la distribución binomial del ejemplo*
...
#1.- ¿Cuál es la probabilidad de que 2 o 3 preguntas sean respondidas correctamente? (Continuación del ejercicio anterior)
...
#2.- Supongamos que la empresa Apple fabricó el Iphone 11S con una probabilidad de 0.005 de ser defectuoso. El producto se envía en una caja que contiene 25 artículos. ¿Cuál es la probabilidad de que una caja elegida al azar contenga un Iphone 11S defectuoso?
